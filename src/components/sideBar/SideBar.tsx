...
const SideBar: React.FC = () => {
  ...
  return (
    <aside
      ...
      } h-screen bg-white text-gray-800 flex flex-col justify-between shadow-2xl transition-all duration-300 ease-in-out border-r border-gray-200 sticky top-0 overflow-hidden`}
    >
      {/* Header */}
      ...
      {/* Links - Con scroll */}
      <nav className="mt-4 flex flex-col gap-1 px-3 flex-1 overflow-y-auto">
      ...
      <div className="border-t border-gray-200 flex-shrink-0">
        ...
        >
          <MdOutlineLogout
            size={20}
            className={isCollapsed ? "text-2xl" : ""}
          />
          {!isCollapsed && (
